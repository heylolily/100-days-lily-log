...
**Today's Progress:** Continued to work on the fcc modules. This time, I learned a bit about jQueries and Bootstrap. After that, I decided to make a boilerplate for my next project. Not sure what it's gonna be, but I'm thinking something like a meditation timer but the timer is adjustable by pressing a button, and then you can start a timer. I'll call it the shut-the-fuck-up-inator LOL idk it just seems like a fun small project to do that's easy but still a bit different. I want to try and implement the jQuery and bootstrap material I learn as well.
